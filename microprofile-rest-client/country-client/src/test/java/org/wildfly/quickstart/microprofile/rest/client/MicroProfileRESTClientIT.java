 ...
 */
package org.wildfly.quickstart.microprofile.rest.client;
...
public class MicroProfileRESTClientIT {
    ...
    private void assertFranceJSON(JsonObject json) {
        Assert.assertEquals("Returned invalid country object", json.getString("name"), "France");
        Assert.assertEquals("Returned invalid country object", json.getString("capital"), "Paris");
        Assert.assertEquals("Returned invalid country object", json.getString("currency"), "EUR");
    }
}
