...
= microprofile-config: MicroProfile REST Client QuickStart
...
mvn archetype:generate \
    -DgroupId=org.wildfly.quickstart.microprofile.rest.client \
...
Create `org.wildfly.quickstart.microprofile.rest.client.JaxRsApplication` with the
following content:
...
`org.wildfly.quickstart.microprofile.rest.client.model.Country` class:
...
`org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient`:
...
Update `org.wildfly.quickstart.microprofile.rest.client.CountriesResource` with the
following content:
...
[source,properties]
----
org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient/mp-rest/url=https://restcountries.eu/rest
org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient/mp-rest/scope=javax.inject.Singleton
----

This configuration means that:

* all requests performed using
`org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient` will use
...
`org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient` will be
`@Singleton`. All supported values are described later. The default scope can also
be defined on the interface.

NOTE that `org.wildfly.quickstart.microprofile.rest.client.CountriesServiceClient`
...
`org.wildfly.quickstart.microprofile.rest.client.NotFoundResponseExceptionMapper`:
