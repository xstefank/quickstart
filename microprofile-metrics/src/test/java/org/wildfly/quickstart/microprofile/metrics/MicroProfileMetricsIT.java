...
public class MicroProfileMetricsIT {
    ...
    public void testPrimeMetrics() {
        ...
        Assert.assertEquals(3, json.getInt("org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.performedChecks"));
        Assert.assertEquals(3, json.getJsonObject("checksTimer").getInt("count"));
        Assert.assertEquals(3, json.getJsonObject("checkIfPrimeFrequency").getInt("count"));
        Assert.assertEquals(29, json.getInt("org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.highestPrimeNumberSoFar"));
    }
    ...
    public void testParallelMetrics() throws Exception {
        ...
        Assert.assertEquals("Invalid number of current parallel accesses",
            3, json.getJsonObject("org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.parallelAccess").getInt("current"));
    ...
    public void testInjectedMetrics() {
        ...
        Assert.assertEquals(3, json.getInt("injectedCounter"));
    }
    ...
    public void testRegistryMetrics() {
        ...
        Assert.assertEquals(42, json.getInt("programmaticCounter"));
    }
    ...
    public void testDuplicatedMetrics() {
        ...
        Assert.assertEquals(1, json.getInt("duplicatedCounter;type=original"));
        Assert.assertEquals(1, json.getInt("duplicatedCounter;type=copy"));
    }
