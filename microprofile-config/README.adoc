...
Create `org.wildfly.quickstart.microprofile.config.JaxRsApplication` with the following content:

NOTE: The new file should be created in
`src/main/java/org/quickstart/microprofile/config/JaxRsApplication.java`.
...
class `org.wildfly.quickstart.microprofile.config.ConfigResource`;
...
* Add the following code to `org.wildfly.quickstart.microprofile.config.ConfigResource`:
...
a new REST resource
`org.wildfly.quickstart.microprofile.config.CustomConfigResource` which will be enclosing
...
`org.wildfly.quickstart.microprofile.config.custom.CustomConfigSource`:
...
`org.wildfly.quickstart.microprofile.config.custom.CustomPropertiesFileProvider`:
...
`org.wildfly.quickstart.microprofile.config.CustomConfigResource`:
...
a new class
`org.wildfly.quickstart.microprofile.config.converter.type.MicroProfileCustomValue`:

[source,java]
----
package org.wildfly.quickstart.microprofile.config.converter.type;
...
`Converter<MicroProfileCustomValue>` implementatation
`org.wildfly.quickstart.microprofile.config.converter.MicroProfileCustomValueConverter`:
...
a new resource class `org.wildfly.quickstart.microprofile.config.ConverterResource`:
