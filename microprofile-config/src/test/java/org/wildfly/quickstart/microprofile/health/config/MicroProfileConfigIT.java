package org.wildfly.quickstart.microprofile.health.config;
...
import org.wildfly.quickstart.microprofile.config.ConfigResource;
...
public class MicroProfileConfigIT {
     ...
     * - 204 No Content on first invocation (custom.properties file does not exist)
