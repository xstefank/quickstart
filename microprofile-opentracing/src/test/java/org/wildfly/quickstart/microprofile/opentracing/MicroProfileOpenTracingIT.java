 ...
 */
package org.wildfly.quickstart.microprofile.opentracing;
...
public class MicroProfileOpenTracingIT {
    ...
    public void testCDITracing() {
        ...
        finishedSpans.forEach(span -> Assert.assertTrue(span.operationName().equals("process-hello") ||
            ...
            span.operationName().equals("org.wildfly.quickstart.microprofile.opentracing.ExplicitlyTracedBean.getHello") ||
            span.operationName().equals("GET:org.wildfly.quickstart.microprofile.opentracing.TracedResource.cdiHello")));
    }
