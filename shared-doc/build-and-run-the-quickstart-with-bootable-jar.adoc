...
You can package a {ProductShortName} server and an application inside a bootable JAR. You can then run the application on a {ProductShortName} bare-metal platform or on a {ProductShortName}  Openshift platform.

== On a {ProductShortName} bare-metal platform

You can use the Maven plug-in to build a {ProductShortName} bootable JAR, and then you can run the application on a {ProductShortName} bare-metal platform. The following example demonstrates a quickstart `pom.xml` file that contains a Maven profile named *bootable-jar*:
...
== On a {ProductShortName} OpenShift platform

You can use the Maven plug-in to build a {ProductShortName} bootable JAR, and then you can run the application on a {ProductShortName} OpenShift platform. The following example demonstrates a quickstart `pom.xml` file that contains a Maven profile named *bootable-jar-openshift*:
